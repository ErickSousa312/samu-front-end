  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const driverResponse = response.data.filter(
          ...
          <div className="max-w-md mx-auto flex flex-col justify-center items-center">
            ...
            <div className="mt-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <form
                ...
                className="flex flex-col justify-center items-center w-[90vw] md:w-[50vw]"
              >
                ...
                <div className="pt-8 w-full gap-4 flex justify-center items-center px-32">
                  <button
                    onClick={onClose}
                    className="bg-gray-500 text-black px-4 py-2 rounded hover:bg-gray-600 w-full"
                  >
                    Fechar
                  </button>
                  <button
